...
..\..\src\utils\buildlevels_MK1.exe ..\bin\level0.bin mapsize=30 mapfile=..\map\mapa0.MAP map_w=3 map_h=10 fixmappy tilesfile=..\gfx\work0.png behsfile=..\gfx\behs0.txt defaultink=7 spritesfile=..\gfx\sprites0.png enemsfile=..\enems\enems0.ene scr_ini=27 ini_x=2 ini_y=8 max_objs=1 enems_life=2 > nul
..\..\src\utils\buildlevels_MK1.exe ..\bin\level1.bin mapsize=30 mapfile=..\map\mapa1.MAP map_w=3 map_h=10 fixmappy tilesfile=..\gfx\work1.png behsfile=..\gfx\behs1.txt defaultink=5 spritesfile=..\gfx\sprites1.png enemsfile=..\enems\enems1.ene scr_ini=27 ini_x=2 ini_y=8 max_objs=1 enems_life=2 > nul
..\..\src\utils\buildlevels_MK1.exe ..\bin\level2.bin mapsize=30 mapfile=..\map\mapa2.MAP map_w=3 map_h=10 fixmappy tilesfile=..\gfx\work2.png behsfile=..\gfx\behs2.txt defaultink=0 spritesfile=..\gfx\sprites2.png enemsfile=..\enems\enems2.ene scr_ini=27 ini_x=2 ini_y=8 max_objs=1 enems_life=2 > nul
..\..\src\utils\buildlevels_MK1.exe ..\bin\level3.bin mapsize=30 mapfile=..\map\mapa3.MAP map_w=3 map_h=10 fixmappy tilesfile=..\gfx\work3.png behsfile=..\gfx\behs3.txt defaultink=7 spritesfile=..\gfx\sprites3.png enemsfile=..\enems\enems3.ene scr_ini=27 ini_x=2 ini_y=8 max_objs=1 enems_life=2 > nul
..\..\src\utils\buildlevels_MK1.exe ..\bin\level4.bin mapsize=30 mapfile=..\map\mapa4.MAP map_w=3 map_h=10 fixmappy tilesfile=..\gfx\work4.png behsfile=..\gfx\behs4.txt defaultink=7 spritesfile=..\gfx\sprites4.png enemsfile=..\enems\enems4.ene scr_ini=27 ini_x=2 ini_y=8 max_objs=1 enems_life=2 > nul
